...
public class Orientation extends Common implements SensorEventListener, RadioGroup.OnCheckedChangeListener{
    ...
    public void updateOreintationDisplay() {
        switch(radioSelection) {
            case 0:
                mAzimuthView.setText(String.format("%s°", d.format(accMagOrientation[0] * 180 / Math.PI)));
                mPitchView.setText(String.format("%s°", d.format(accMagOrientation[1] * 180 / Math.PI)));
                mRollView.setText(String.format("%s°", d.format(accMagOrientation[2] * 180 / Math.PI)));
                break;
            case 1:
                mAzimuthView.setText(String.format("%s°", d.format(gyroOrientation[0] * 180 / Math.PI)));
                mPitchView.setText(String.format("%s°", d.format(gyroOrientation[1] * 180 / Math.PI)));
                mRollView.setText(String.format("%s°", d.format(gyroOrientation[2] * 180 / Math.PI)));
                break;
            case 2:
                mAzimuthView.setText(String.format("%s°", d.format(fusedOrientation[0] * 180 / Math.PI)));
                mPitchView.setText(String.format("%s°", d.format(fusedOrientation[1] * 180 / Math.PI)));
                mRollView.setText(String.format("%s°", d.format(fusedOrientation[2] * 180 / Math.PI)));
                break;
        }
    }
